...
public class BookController {
	...
	@PostMapping("/add")
	public ResponseEntity<?> addBook(@RequestBody BookDto dto, BindingResult bindingResult) {
	...
	@GetMapping("/list")
	public ResponseEntity<?> getbooksList(@RequestBody BookDto dto, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			String errorMessage = bindingResult.getFieldErrors().stream()
					.map(error -> error.getDefaultMessage().toString()).collect(Collectors.joining(", "));
	...
	@GetMapping("/details")
	public ResponseEntity<?> getbookById(@RequestBody BookDto dto, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			String errorMessage = bindingResult.getFieldErrors().stream()
					.map(error -> error.getDefaultMessage().toString()).collect(Collectors.joining(", "));
	...
	@PutMapping("/update")
	public ResponseEntity<?> updateBook(@RequestBody BookDto dto, BindingResult bindingResult) {
	...
	public ResponseEntity<?> updateBookStatus(@RequestBody BookDto dto, BindingResult bindingResult) {
